                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    @elseif ($pendaftaran->status == 'lulus' || $pendaftaran->status == 'diterima')
                                        <span class="badge badge-light-success fw-bolder ms-2 fs-8 py-1 px-3" style="background-color: #e8fff3; color: #50cd89;">{{ ($pendaftaran->status == 'lulus' || $pendaftaran->status == 'diterima') ? 'Lulus' : 'Diterima' }}</span>
