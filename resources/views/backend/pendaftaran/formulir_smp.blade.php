...
@section('pendaftaran-smp-menu-active', 'active')
@section('formulir-menu-open', 'show')

@section('content')
    <!--begin::Card-->
    <div class="card" style="background-color: #f0f8ff; border: 1px solid #cce5ff;">
        <!--begin::Card header-->
        <div class="card-header border-0 pt-6">
            <!--begin::Card title-->
            <div class="card-title">
                <h3>Formulir Pendaftaran SMP</h3>
            </div>
            <!--begin::Card title-->
        </div>
        <!--end::Card header-->
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="tab-content" id="wizardTabContent">
                    ...
                    <div class="tab-pane fade" id="step4" role="tabpanel">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="sekolah_pilihan_1" class="form-label">Pilihan 1 (Sesuai Kecamatan, Daftar Unggulan)</label>
                                <select class="form-control select2" id="sekolah_pilihan_1" name="sekolah_pilihan_1" required>
                                    ...
                                    <optgroup label="Kecamatan Banda Sakti">
                                        <option value="CA">SMP Negeri 1 Banda Sakti</option>
                                        <option value="NV">SMP Negeri 2 Banda Sakti</option>
                                        <option value="OR">SMP Negeri 3 Banda Sakti</option>
                                        <option value="WA">SMP Negeri 4 Banda Sakti</option>
                                    </optgroup>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label for="sekolah_pilihan_2" class="form-label">Pilihan 2 (Sesuai Kecamatan, diluar Daftar Unggulan)</label>
