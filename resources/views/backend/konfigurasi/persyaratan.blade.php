...
@section('persyaratan-menu-active')
    active
@endsection
...
<div class="card mb-5 mb-xl-10">
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">Persyaratan Pendaftaran</h3>
        </div>
    </div>
    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <form id="kt_persyaratan_form" class="form" method="POST" action="{{ route('konfigurasi.persyaratan.update') }}">
            @csrf
            <div class="card-body border-top p-9">
                <!-- Persyaratan -->
                <div class="row mb-6">
                    <label class="col-lg-12 col-form-label required fw-bold fs-6">Isi Persyaratan</label>
                    <div class="col-lg-12 fv-row">
                        <textarea name="nilai" id="isi_persyaratan" class="form-control form-control-lg form-control-solid @error('nilai') is-invalid @enderror" rows="20">{{ $persyaratan->nilai ?? old('nilai') }}</textarea>
                        @error('nilai')
