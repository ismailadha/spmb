        ...
        <div class="card-body py-4">
            ...
            <form action="{{ route('sambutan.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="mb-3">
                            <label for="id" class="form-label">ID (Unique)</label>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="foto" name="foto" value="{{ old('foto') }}" readonly placeholder="Klik Browse untuk memilih gambar...">
                            ...
                            <div id="foto_preview" class="mt-2" style="display:none;">
                                <img id="foto_img" src="" alt="Preview" class="img-fluid" style="max-width:200px; border-radius:4px;">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="isi_sambutan" class="form-label">Isi Sambutan</label>
                            <textarea class="form-control" id="isi_sambutan" name="isi_sambutan" rows="5">{{ old('isi_sambutan') }}</textarea>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="mb-3">
                            <label for="sort_order" class="form-label">Sort Order</label>
                            <input type="number" class="form-control" id="sort_order" name="sort_order" value="{{ old('sort_order', 1) }}" required>
                        </div>
                        <div class="mb-3">
