            ...
            <div class="alert alert-dismissible bg-light-info d-flex flex-column flex-sm-row p-5 mb-5">
                ...
                <div class="d-flex flex-column pe-0 pe-sm-10">
                    ...
                    <div class="fs-7">
                        ...
                        <strong>Skor Usia:</strong> Dihitung dalam satuan hari berdasarkan selisih antara tanggal lahir dengan batas usia minimal ({{ \Carbon\Carbon::parse($periode->tanggal_batas_usia_smp)->format('d F Y') }}).
                    </div>
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
