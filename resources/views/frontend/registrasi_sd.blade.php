...
<html lang="en">
    <head>
        ...
        <title>Registrasi Calon Siswa Sekolah Dasar</title>
                                ...
                                <div class="form-wrapper">
                                    <div class="card card-shadow">
                                        <div class="card-header">
                                            <h4 class="text-center">Registrasi Calon Siswa Sekolah Dasar</h4>
                                        </div>
                                        <div class="card-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="nik" name="nik" value="{{ Auth::user()->username }}" readonly>
                                                                                </div>
                                                                                <div class="form-group">
