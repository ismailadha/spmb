...
<div class="zonasi-header text-center mb-5">
    <div class="container">
        <h1 class="display-4 font-weight-bold text-dark">Informasi Zonasi Sekolah</h1>
        <p class="lead text-secondary mt-3 mx-auto" style="max-width: 800px;">
            Informasi zonasi sekolah jenjang SD di Kota Lhokseumawe berdasarkan aturan zonasi PPDB.
        </p>
    </div>
</div>
