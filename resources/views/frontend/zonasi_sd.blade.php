...
<section class="breadcrumb_area breadcrumb2 bgimage" style="background-image: url('{{ asset('images/zona.jpg') }}'); background-size: cover; padding: 120px 0; background-position: center; position: relative; overflow: hidden;">
    ...
    <div class="container text-center position-relative" style="z-index: 2;">
        <h1 class="text-white font-weight-bold display-4 mb-2 animate__animated animate__fadeInDown">Informasi Zonasi Sekolah Dasar</h1>
        <p class="text-white-50 lead animate__animated animate__fadeInUp">Informasi zonasi sekolah jenjang SD di Kota Lhokseumawe berdasarkan aturan zonasi PPDB</p>
    </div>
</section>
    ...
    <div class="sekolah-list mt-5">
        ...
        @if($sekolahGrouped->isEmpty())
            <div class="alert alert-info text-center shadow-sm rounded-xl py-4">
                <i class="fas fa-info-circle mr-2"></i> Belum ada data sekolah jenjang SD yang tersedia.
            </div>
        @else
