...
<section class="breadcrumb_area breadcrumb2 bgimage" style="background-image: url('https://images.unsplash.com/photo-1510531704581-5b2870972060?auto=format&fit=crop&w=1920&q=80'); background-size: cover; padding: 120px 0; background-position: center; position: relative; overflow: hidden;">
    ...
    <div class="container text-center position-relative" style="z-index: 2;">
        ...
        <p class="text-white-50 lead animate__animated animate__fadeInUp">Temukan data Sekolah Menengah Pertama (SMP) terdekat di wilayah Anda</p>
    </div>
</section>
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-md-6">
                                <h5 class="mb-0 font-weight-bold" style="color: #1e2a4a; font-size: 1.25rem;">
                                    <span class="d-inline-block px-3 py-2 rounded-lg bg-primary-soft mr-2">
                        ...
                        <form action="{{ route('sekolah-smp') }}" method="GET" class="filter-form">
                            <div class="row">
                                <div class="col-lg-5 col-md-4 mb-3 mb-lg-0">
                                    <div class="form-group mb-0 position-relative">
                                        ...
                                        <div class="search-input-wrapper">
                                            <i class="la la-search input-icon text-primary"></i>
                                ...
                                <div class="col-lg-3 col-md-4 d-flex align-items-end">
                                    <button type="submit" class="btn btn-premium-primary w-100 shadow-sm py-3" style="border-radius: 12px; font-weight: 700;">
...
<style>
    :root {
        ...
        --primary-soft: rgba(26, 188, 156, 0.1);
        --dark-navy: #1e2a4a;
    }
    ...
    .btn-outline-premium-primary {
        border: 2px solid #3498db;
        color: #3498db;
        transition: all 0.3s ease;
    }

    .btn-outline-premium-primary:hover {
        background: var(--primary-gradient);
        color: #fff;
