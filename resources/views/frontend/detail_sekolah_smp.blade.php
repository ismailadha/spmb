...
@section('content')
<!-- Detail Hero Header -->
<section class="breadcrumb_area breadcrumb2 bgimage" style="background-image: url('https://images.unsplash.com/photo-1546410531-bb4caa6b424d?auto=format&fit=crop&w=1920&q=80'); background-size: cover; padding: 100px 0; position: relative;">
    <div class="overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(to right, rgba(30, 42, 74, 0.9), rgba(26, 188, 156, 0.6));"></div>
    <div class="container position-relative" style="z-index: 2;">
        <div class="row align-items-center">
            <div class="col-lg-8 text-center text-lg-left">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent p-0 mb-3 justify-content-center justify-content-lg-start">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('sekolah-smp') }}" class="text-white-50">Sekolah Menengah Pertama</a></li>
                ...
                <div class="d-flex flex-wrap justify-content-center justify-content-lg-start align-items-center">
                    <span class="badge badge-primary px-3 py-2 mr-3 mb-2 shadow-sm" style="border-radius: 8px; font-size: 0.9rem; background: #1abc9c;">
            ...
            <div class="col-lg-4 text-center text-lg-right mt-4 mt-lg-0 animate__animated animate__fadeInRight">
                <a href="#daftar" class="btn btn-light btn-lg px-4 py-3 rounded-pill font-weight-bold shadow" style="color: #1abc9c; border: none;">
            ...
            <div class="col-lg-8 mb-4">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="section-title mb-4">
                            <h4 class="font-weight-bold" style="color: #1e2a4a;">
                                <span class="d-inline-block p-2 rounded-lg bg-primary-soft mr-2"><i class="la la-chart-bar text-primary"></i></span>
                        ...
                        <div class="total-quota bg-primary-soft p-4 rounded-xl mt-2 text-center">
                            <h5 class="mb-1 font-weight-bold text-primary" style="color: #1abc9c !important;">Total Daya Tampung</h5>
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                    <div class="card-body p-4 p-md-5">
                        <div class="section-title mb-4">
                            <h4 class="font-weight-bold" style="color: #1e2a4a;">
                                <span class="d-inline-block p-2 rounded-lg bg-primary-soft mr-2"><i class="la la-info-circle text-primary"></i></span>
                                Informasi Tambahan
                            </h4>
                        </div>
                        <div class="info-list">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px; overflow: hidden;">
                    <div class="image-wrapper" style="height: 200px; overflow: hidden;">
                        ...
                        @else
                            <img src="https://images.unsplash.com/photo-1546410531-bb4caa6b424d?auto=format&fit=crop&w=600&q=80" class="w-100 h-100 object-fit-cover" alt="Default School">
                        @endif
                    </div>
                    <div class="card-body p-4">
                        <h5 class="font-weight-bold mb-4" style="color: #1e2a4a;">Identitas Sekolah</h5>
                        <div class="d-flex align-items-center mb-3">
                            <div class="icon-square mr-3 bg-light text-primary" style="color: #1abc9c !important;"><i class="la la-fingerprint"></i></div>
                            <div>
                        ...
                        <div class="contact-buttons">
                            @if($sekolah->website)
                                <a href="{{ Str::startsWith($sekolah->website, 'http') ? $sekolah->website : 'https://' . $sekolah->website }}" target="_blank" class="btn btn-outline-primary btn-block rounded-pill mb-2 font-weight-bold" style="border-color: #1abc9c; color: #1abc9c;">
                ...
                <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                    <div class="card-body p-4">
                        ...
                        <a href="https://www.google.com/maps/dir/?api=1&destination={{ $sekolah->latitude }},{{ $sekolah->longitude }}" target="_blank" class="btn btn-primary btn-block py-3 rounded-xl font-weight-bold" style="background: #1abc9c; border: none;">
...
<style>
    ...
    .bg-primary-soft { background-color: rgba(26, 188, 156, 0.08); }
    ...
    .transition-hover:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(0,0,0,0.05) !important; border-color: #1abc9c !important; }
    .object-fit-cover { object-fit: cover; }
    .breadcrumb-item + .breadcrumb-item::before { color: rgba(255,255,255,0.5); }
    .btn-outline-primary:hover { background: #1abc9c; border-color: #1abc9c; color: #fff !important; }
</style>
@endsection
